//ADDED A CONTINUOUS FUNCTION OF DO WHILE LOOP !
#include<stdio.h>
#include<conio.h>
#include<stdlib.h>
int main()
{
	...
	printf("\t|        |\n");
	printf("\t__________=g\n");
       //adding a continuous functionof looop
	printf("Enter how many times the alphabets prints ?");
	scanf_s("%d", &count_to);
	//hint=a,b,c,d,e,f=1 and g=0 would print =>>"A"and similar to numbers like segments of a seven segments led
	int count = 0;
	do{	
         	printf("enter a :\n");
		scanf_s("%d", &a);
